...
export const PROJECT = {
  ...
  version: '1.0.0',
  license: 'GPL-3.0',
  url: 'https://space-adventure.minidev.app',
  repository: 'https://github.com/MiniDevPlatform/space-adventure',
} as const;
...
export const FEATURES = {
  ...
  // Campaign
  campaign: { enabled: false, levels: [], achievements: [], saveProgress: true, saveKey: 'space-adventure_progress' },
